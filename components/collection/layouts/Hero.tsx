      ...
      <div ref={ref} className="container-custom section-padding relative">
        <div className="max-w-4xl mx-auto text-center">
          <div className={cn("opacity-0", isVisible && "animate-fade-in-down")}>
            <span className="inline-flex items-center gap-4 px-6 py-4 rounded-full bg-primary-foreground/10 border border-primary-foreground/20 text-sm font-medium mb-6">
          ...
          <div
            className={cn(
              "grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto opacity-0",
          ...
          >
            {[
              ...
              <div
                key={index}
                className="flex flex-col items-center p-6 rounded-xl bg-primary-foreground/10 backdrop-blur-sm"
              >
